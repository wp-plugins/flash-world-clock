...
#    	   return; 
	...
	if ( $_POST['world-clock-submit'] ) {
	     $options_flag=1;
      	...
      	echo '<ul><li style="text-align:center;list-style: none;"><label for="clock-title">World Clock<br> by <a href="http://localtimes.info">localtimes.info</a></label></li>';
	...
	echo "\n";
         ...
         '<select id="world-clock-size" name="world-clock-size"  style="width:75px">';
      	...
      	echo '<li style="list-style: none;"><label for="world-clock-border-color">'.'Border Color:&nbsp;';
       	echo '<select id="world-clock-border-color" name="world-clock-border-color"  style="width:75px" >';
      	print_wbordercolor_list($border_color);
      	echo '</select></label>';
      	echo '</li>';
	...
	$target_url = "http://localtimes.info/getwidget/world/";
